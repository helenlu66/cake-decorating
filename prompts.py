...
constraints_extraction_prompt = PromptTemplate(input_variables=['example_robot_question', 'example_human_answer', 'variables', 'example_constraints', 'robot_question', 'human_answer', 'surface_width', 'surface_height'], template="""
